...
namespace GuateShop.FrontEnd.Repositories
{
    public class Repository : IRepository
    {
        ...
        private JsonSerializerOptions _defaultJsonOptions => new JsonSerializerOptions()
        ...
        public async Task<HttpResponseWrapper<object>> PostAsync<T>(string url, T model)
        {
            ...
            var responseHttp = await _httpClient.PutAsync(url, modelContent);
        ...
        private async Task<T> UnserializeAnswer<T>(HttpResponseMessage responseHttp)
        {
            ...
            return JsonSerializer.Deserialize<T>(response, _defaultJsonOptions)!;
        }
    }
}